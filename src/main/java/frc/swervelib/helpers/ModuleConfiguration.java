 ...
 * example, the Swerve Drive Specialties Mk3 swerve module has two
 * configurations, standard and fast, and therefore should have two
 * configurations ({@link SdsModuleConfigurations#MK3_STANDARD} and
...
public class ModuleConfiguration {
     ...
     *                       an odd number of gea reductions this is typically true.
     ...
     *         <p>
     *         If this value is multiplied by drive motor rotations the result would
     *         be drive wheel rotations.
     */
     ...
     *         <p>
     *         If this value is multiplied by steering motor rotations the result
     *         would be steering pulley rotations.
     */
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getWheelDiameter(), getDriveReduction(), isDriveInverted(), getSteerReduction(), isSteerInverted());
    }
