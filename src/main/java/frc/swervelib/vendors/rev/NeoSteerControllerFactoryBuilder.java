package frc.swervelib.vendors.rev;
...
public final class NeoSteerControllerFactoryBuilder {
    ...
    public <T> SteerControllerFactory<ControllerImplementation, NeoSteerConfiguration<T>>
                    build(AbsoluteEncoderFactory<T> encoderFactory) {
