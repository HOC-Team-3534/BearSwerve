...
public final class Falcon500DriveControllerFactoryBuilder {
    ...
    public Falcon500DriveControllerFactoryBuilder
    ...
    private class FactoryImplementation implements DriveControllerFactory<ControllerImplementation, Integer> {
        ...
        public ControllerImplementation create(Integer driveConfiguration,
            ...
            if (RobotBase.isSimulation()) {
                motor.setStatusFramePeriod(StatusFrameEnhanced.Status_1_General, STATUS_FRAME_GENERAL_PERIOD_MS_SIM, CAN_TIMEOUT_MS_SIM);
            } else {
    ...
    private class ControllerImplementation implements DriveController {
        ...
        private ControllerImplementation(WPI_TalonFX motor, double sensorVelocityCoefficient) {
            ...
            sensorPositionCoefficient = sensorVelocityCoefficient / 10;
        }
