...
class MotorGearboxWheelSim {
    ...
    /**
     * 1D simulation of a motor, gearbox, and wheel. Provides an output torque,
     * given an input speed and voltage.
     * 
     * @param motor                         Motor set used to provide power input.
     * @param gearRatio                     Gearbox Ratio. Gearboxes which slow down
     *                                      motors (ie all of them) should have this
     *                                      greater than 1.0.
     * @param wheelRadiusM                  Radius of the wheel in meters
     * @param gearboxFricCoefNmPerRadPerSec Kinetic Friction Losses in the gearbox
     *                                      (expressed in units of Nm of "fighting"
     *                                      force per radian per second of motor
     *                                      speed). Set to 0 if you're awesome with
     *                                      white lithium grease, make it positive
     *                                      if your team maybe forget the grease
     *                                      sometimes.
     */
    MotorGearboxWheelSim(DCMotor motor, double gearRatio, double wheelRadiusM,
