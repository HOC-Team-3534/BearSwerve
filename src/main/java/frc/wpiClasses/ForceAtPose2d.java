...
public class ForceAtPose2d {
  ...
  /**
   * @param centerOfRotation Pose at the center of rotation that the torque should
   *                         be calculated from
   * 
   * @return Returns the torque associated with this force at distance. positive
   *         is counter-clockwise, negative is clockwise
   */
